...
public class Info {
    ...
    @JsonProperty("gameCreation")
    public void setGameCreation(long value) {
        this.gameCreation = value;
    }
    ...
    @JsonProperty("gameEndTimestamp")
    public void setGameEndTimestamp(long value) {
        this.gameEndTimestamp = value;
    }
    ...
    @JsonProperty("gameStartTimestamp")
    public void setGameStartTimestamp(long value) {
        this.gameStartTimestamp = value;
    }
    ...
    @JsonProperty("tournamentCode")
    public void setTournamentCode(String value) {
        this.tournamentCode = value;
    }
